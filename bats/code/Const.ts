...
export const ViewNetProcessorDir = resolve(__workname, "src/core/ui/viewNetProcessor");
...
export const NetworkDir = resolve(NetDir, "network");
...
export const UserDataPath = resolve(NetworkDir, "Interface.d.ts");
export const UserDataEventPath = resolve(__workname, "src/core/userData/UserDataEvent.ts")

export const MODIFY_TIP = "/**This is automatically generated by BatMain.bat , please do not modify */\n";